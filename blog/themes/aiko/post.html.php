...
<article class="post full">
    ...
    <?php if (!empty($p->quote)) { ?>
        <div class="featured featured-quote">
            <blockquote class="quote">
                <p><i class="fa fa-quote-left"></i> <?php echo $p->quote ?> <i class="fa fa-quote-right"></i></p>
            </blockquote>
        </div>
    <?php } ?>
    ...
    <mastodon-comments host="blorbo.social" user="hako_aiko" tootId="<?php echo get_field('toot_id', $p->raw);?>"></mastodon-comments>
    <?php if (disqus()) : ?>
